...
pub fn game_startable() -> GameStartable {
  GameStartable::new()
    ...
    // )
    // animate GI posts
    .effect(LedEffect::rotate(
      POST_LEDS1.q(),
      ColorSequence::fade(Rgba::cyan().darken(0.25), Rgba::pink().darken(0.25)).padding_right(4),
      Duration::from_millis(750),
      RotationDirection::CounterClockwise,
    ))
  // .effect(LedEffect::rotate(
  //   POST_LEDS4.q(),
  //   ColorSequence::fade(Rgba::cyan().darken(0.25), Rgba::pink().darken(0.25)).padding_left(4),
  //   Duration::from_millis(750),
