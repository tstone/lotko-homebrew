...
use crate::hardware::{arc_ramp, lift_ramp, pop_cluster};
...
// TODO: Maybe this mode should be N spins on the v-spinner instead of targets
// each subsequent ramp hit adds a ball (when stacked with nimbus that's 4 balls)
